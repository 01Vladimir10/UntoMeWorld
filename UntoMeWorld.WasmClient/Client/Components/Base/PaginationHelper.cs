...
public class PaginationHelper<T>
{
    ...
    private Func<QueryFilter, string, bool, int, int, Task<PaginationResult<T>>> PaginationDelegate { get; }

    public PaginationHelper(Func<QueryFilter, string, bool, int, int, Task<PaginationResult<T>>> paginationDelegate)
    {
    ...
    {
        var pageResult = await PaginationDelegate(Filter, SortBy, SortDesc, ++PageIndex, PageSize);
